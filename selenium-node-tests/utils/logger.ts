...
export class Logger {
  ...
  public static init(reportsDir: string = './Test Results'): void {
    ...
    Logger.logFilePath = path.join(Logger.logDir, `selenium_run_${timestamp}.log`);
    Logger.write(`[INIT] VitalCore Selenium E2E Test Suite Started at ${new Date().toISOString()}`);
  }
