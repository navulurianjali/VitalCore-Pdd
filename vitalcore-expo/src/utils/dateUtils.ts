/**
 * VitalCore Date Utility (Expo)
 * ==========================================
 * Provides consistent, local-timezone date handling for daily resets,
 * history tracking, and cross-platform synchronization between Expo and Web.
 */

/**
 * Returns YYYY-MM-DD in the user's local device timezone.
 */
